...
- push updates remote refs and associated objects
or pushed

- pull fetches and integrates with another repository or local branch

- add adds file contents to the index

- commit records changes to the repository
- -m leaves a message with the commit command
